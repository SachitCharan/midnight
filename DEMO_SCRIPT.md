# Midnight demo script — target 4:40
...
the night sky. Midnight makes this invisible pollution personal: it shows whether
...
Show `astronomy.py`. Midnight computes solar and lunar positions from orbital
...
population divided by distance to the 2.5 power. Midnight sums nearby contributions
...
Midnight is for anyone who wants to reconnect with the night sky but does not know
...
light data. Midnight tells you whether you can see stars tonight, why you can't,
